			...
			<div class="row align-items-center fill_height">
				<div class="col">
					<div class="main_slider_content">
						<h6>galaxygaming / los mejores servidores</h6>
						<h1>¡Obten 500 puntos adicionales por oferta navideña!</h1>
				...
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(views/images/cpu.jpg)">
						<div class="banner_category">
							<a href="categories">servidor 1</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(views/images/cpu.jpg)">
						<div class="banner_category">
							<a href="categories">servidor 2</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(views/images/cpu.jpg)">
						<div class="banner_category">
							<a href="categories">servidor 3</a>
						</div>
					</div>
				</div>
			</div>
